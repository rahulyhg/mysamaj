...
public class WebServiceA {
	...
	public static String invokeAddressWS(String intAddressId, String WebMethod) {
		...
		// Set Username
		unamePI.setName("addressId");
		// Set Value
		unamePI.setValue(intAddressId);
		// Set dataType
	...
	public static String invokeAddressUpdateWS(String intAddressId,
		...
		PropertyInfo address1GJPI = new PropertyInfo();
		PropertyInfo address2GJPI = new PropertyInfo();
		PropertyInfo address3GJPI = new PropertyInfo();
		...
		/*
		 * address1PI.setName("address1"); address1PI.setValue(address1);
		 * address1PI.setType(String.class); request.addProperty(address1PI);
		 * 
		 * address2PI.setName("address2"); address2PI.setValue(address2);
		 * address2PI.setType(String.class); request.addProperty(address2PI);
		 * 
		 * address3PI.setName("address3"); address3PI.setValue(address3);
		 * address3PI.setType(String.class); request.addProperty(address3PI);
		 */

		address1GJPI.setName("strAddress1GJ");
		address1GJPI.setValue(address1);
		address1GJPI.setType(String.class);
		request.addProperty(address1GJPI);

		address2GJPI.setName("strAddress2GJ");
		address2GJPI.setValue(address2);
		address2GJPI.setType(String.class);
		request.addProperty(address2GJPI);

		address3GJPI.setName("strAddress3GJ");
		address3GJPI.setValue(address3);
		address3GJPI.setType(String.class);
		request.addProperty(address3GJPI);
