...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	public void Add_Contact(PersonDetailsItem personItem) {
		...
		values.put(KEY_NAME, personItem.getStrNameEN()); // Contact Name
		values.put(KEY_PH_NO, personItem.getStrMobile()); // Contact Phone
		values.put(KEY_EMAIL, personItem.getStrEmailid()); // Contact Email
		// Inserting Row
	...
	PersonDetailsItem Get_Contact(int id) {
		...
		PersonDetailsItem contact = new PersonDetailsItem(Integer.parseInt(cursor.getString(0)),
		...
		try {
			...
			if (cursor.moveToFirst()) {
				do {
					...
					contact.setStrNameEN(cursor.getString(1));
					contact.setStrMobile(cursor.getString(2));
					contact.setStrEmailid(cursor.getString(3));
