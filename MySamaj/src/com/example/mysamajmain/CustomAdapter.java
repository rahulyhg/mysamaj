...
public class CustomAdapter extends ArrayAdapter<PersonDetailsItem> implements
	...
	static class ViewHolder {
		public TextView fullNameEN, intAge, intGender, intMaritalStatus,
				...
				strMobile2, strProfileImage, strPersonId;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.fullNameEN.setText(personItem.getStrSurnameEN() + " "
				+ personItem.getStrNameEN() + " "
				+ personItem.getStrFatherNameEN());
		...
		viewHolder.strJobDetailsEN.setText(personItem.getStrJobDetailEN());
		...
		case 1:
			viewHolder.intGender.setText("Male");
			loader = R.drawable.male;
			break;
		case 2:
			viewHolder.intGender.setText("Female");
		...
		case 1:
			viewHolder.intMaritalStatus.setText("Married");
			break;
		case 2:
			viewHolder.intMaritalStatus.setText("Unmarried");
			break;
		case 3:
			viewHolder.intMaritalStatus.setText("Other");
			break;
		case 4:
			viewHolder.intMaritalStatus.setText("Ganga Swaroop");
			break;
		case 5:
			viewHolder.intMaritalStatus.setText("Widower");
			break;
		case 6:
			viewHolder.intMaritalStatus.setText("Engage");
			break;
		case 7:
			viewHolder.intMaritalStatus.setText("Widow");
			break;
