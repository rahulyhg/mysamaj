...
public class WebServicesD {
	...
	private static String SOAP_ACTION = "http://tempuri.org/m_sptbPersonalDetailMaster_GetUserByFamilyId";
	private static String WEB_METHOD = "m_sptbPersonalDetailMaster_GetUserByFamilyId";
	private static String resTxt = "";

	public static String invokeHelloWorldWS(String familyId) {
		...
		// Set Username
		unamePI.setName("familyId");
		// Set Value
		unamePI.setValue(familyId);
		// Set dataType
